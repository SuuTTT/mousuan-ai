...
export default function StructuralInformationPage() {
  return <PrinciplePage
    zh={{
      ...
      sources: [["《人工智能科学——智能的数学原理》", "/books#artificial-intelligence-science"], ["2016 TIT PDF：结构信息与网络动力学复杂性", "https://ieeexplore.ieee.org/iel7/18/7473802/07456290.pdf"], ["Structural Information Learning Machinery · arXiv", "https://arxiv.org/abs/2001.09637"]],
    ...
    en={{
      ...
      sources: [["Artificial Intelligence Science — Mathematical Principles of Intelligence", "/books#artificial-intelligence-science"], ["2016 TIT PDF: Structural Information and Dynamical Complexity of Networks", "https://ieeexplore.ieee.org/iel7/18/7473802/07456290.pdf"], ["Structural Information Learning Machinery · arXiv", "https://arxiv.org/abs/2001.09637"]],
