...
export default function AIPrinciplesPage() {
  return <PrinciplePage
    zh={{
      ...
      sources: [["《人工智能科学——智能的数学原理》", "/books#artificial-intelligence-science"], ["《孙子兵法的人工智能原理》· 后续展开", "/sun-tzu-ai-principles.pdf#page=502"], ["三部研究专著", "/books"], ["李昂生教授团队", "/team"]],
    ...
    en={{
      ...
      sources: [["Artificial Intelligence Science — Mathematical Principles of Intelligence", "/books#artificial-intelligence-science"], ["AI Principles of Sun Tzu’s The Art of War · later development", "/sun-tzu-ai-principles.pdf#page=502"], ["Three research monographs", "/books"], ["Professor Angsheng Li’s team", "/team"]],
