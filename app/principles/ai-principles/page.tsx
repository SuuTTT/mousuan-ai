...
export default function AIPrinciplesPage() {
  return <PrinciplePage
    zh={{
      ...
      sections: [["智能论题 · 定义 34.5", "一个智能体的智能就是它的信息，即：智能 =（狭义）信息。孙子模型的六个步骤都以信息为数学基础。"], ["科学原理 · 智", "定义 34.3 将学习、自我意识和博弈／谋算规定为人工智能科学原理。"], ["工程原理 · 能", "孙子模型以决策、行动和系统验证作为后三个工程步骤，把科学原理落实为可运行、可检验的过程。"], ["孙子模型 · 定义 34.4", "中文“智能”已蕴含实现结构：智是科学原理，能是工程原理；六个步骤连接认知、策略、执行与验证。"], ["谋算双脑体系结构", "谋策略体系结构与算策略体系结构分工协同，使层谱抽象与分而治之在同一机器智能系统中结合。"]],
