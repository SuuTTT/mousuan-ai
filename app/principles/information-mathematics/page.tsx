...
export default function InformationMathematicsPage() {
  return <PrinciplePage
    zh={{
      ...
      title: "信息的数学原理\n演算、解码与生成",
      lead: "信息世界的认知模型，即总方法或总策略，是层谱抽象。信息的数学原理以信息演算理论、信息解码原理和信息生成原理为三大支柱，并被表述为层谱抽象策略的数学原理、信息世界的数学原理或离散系统的微积分。",
