...
export default function InformationMathematicsPage() {
  return <PrinciplePage
    zh={{
      ...
      sources: [["信息科学文章：打破香农的墙", "https://mp.weixin.qq.com/s?__biz=MzYzOTIyNDYyNw==&mid=2247484707&idx=1&sn=dbcd0f5d6f3b6df0caef00c1900d9e74"], ["《人工智能科学——智能的数学原理》购书入口", "/books"]],
    ...
    en={{
      ...
      sources: [["Article: Beyond Shannon’s wall", "https://mp.weixin.qq.com/s?__biz=MzYzOTIyNDYyNw==&mid=2247484707&idx=1&sn=dbcd0f5d6f3b6df0caef00c1900d9e74"], ["Artificial Intelligence Science — purchase entry", "/books"]],
