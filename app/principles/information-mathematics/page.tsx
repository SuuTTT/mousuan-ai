...
export default function InformationMathematicsPage() {
  return <PrinciplePage
    zh={{
      ...
      title: "信息的数学原理\n为信息世界建立数学语言。",
      lead: "信息演算、信息解码与信息生成，构成描述离散信息世界的三大数学支柱。",
      ...
      sources: [["信息科学文章：打破香农的墙", "https://mp.weixin.qq.com/s?__biz=MzYzOTIyNDYyNw==&mid=2247484707&idx=1&sn=dbcd0f5d6f3b6df0caef00c1900d9e74"], ["《人工智能科学——智能的数学原理》", "/ai-science-mathematical-principles.pdf"]],
    ...
    en={{
      ...
      lead: "Information calculus, information decoding, and information generation form three mathematical pillars for describing discrete information-world systems.",
      ...
      sources: [["Article: Beyond Shannon’s wall", "https://mp.weixin.qq.com/s?__biz=MzYzOTIyNDYyNw==&mid=2247484707&idx=1&sn=dbcd0f5d6f3b6df0caef00c1900d9e74"], ["Artificial Intelligence Science — Mathematical Principles", "/ai-science-mathematical-principles.pdf"]],
