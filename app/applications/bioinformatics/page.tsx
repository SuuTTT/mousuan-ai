...
export default function BioinformaticsPage() {
  return <PrinciplePage
    zh={{
      ...
      sourcesLabel: "研究入口",
      sources: [["曾广杰 · 基于结构熵的无监督皮肤病变分割", "https://arxiv.org/abs/2309.01899"], ["曾广杰 · 不同约束下的半监督结构熵聚类", "https://arxiv.org/abs/2312.10917"], ["曾广杰 · SECTOR：空间转录组时空组织的结构熵学习", "https://doi.org/10.1093/bioinformatics/btag367"], ["信息世界的数学原理", "/principles/information-mathematics"], ["结构信息原理", "/principles/structural-information"], ["术语 Wiki", "/wiki/terminology"]],
    ...
    en={{
      ...
      sources: [["Guangjie Zeng · Unsupervised skin-lesion segmentation via structural entropy", "https://arxiv.org/abs/2309.01899"], ["Guangjie Zeng · Semi-supervised clustering via structural entropy with different constraints", "https://arxiv.org/abs/2312.10917"], ["Guangjie Zeng · SECTOR: structural-entropy learning of spatiotemporal organisation in spatial transcriptomics", "https://doi.org/10.1093/bioinformatics/btag367"], ["Mathematical principles of the information world", "/principles/information-mathematics"], ["Structural information principles", "/principles/structural-information"], ["Terminology Wiki", "/wiki/terminology"]],
