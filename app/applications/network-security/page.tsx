...
export default function NetworkSecurityPage() {
  return <PrinciplePage
    zh={{
      ...
      sourcesLabel: "研究入口",
      sources: [["彭浩 · 动态图结构熵增量测量（AIJ）", "https://penghao-bdsc.github.io/papers/AIJ2024-Incremental%20Measurement%20of%20Structural%20Entropy%20for%20Dynamic%20Graphs.pdf"], ["彭浩 · 结构熵最小化与无监督社会事件检测", "https://penghao-bdsc.github.io/papers/Hierarchical%20and%20Incremental%20Structural%20Entropy%20Minimization%20for%20Unsupervised%20Social%20Event%20Detection.pdf"], ["结构信息原理", "/principles/structural-information"], ["结构化决策", "/applications/structured-decision-making"], ["术语 Wiki", "/wiki/terminology"]],
