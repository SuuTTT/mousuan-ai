...
export default function EmbodiedIntelligencePage() {
  return <PrinciplePage
    zh={{
      ...
      sources: [["获得信息，不等于获得利：自我意识文章", "https://mp.weixin.qq.com/s?__biz=MzYzOTIyNDYyNw==&mid=2247484239&idx=1&sn=ed7b32ef7f916a282da9ba673ffe481c"], ["关于我们 · 李昂生教授团队", "/team"]],
      closing: "信息原理的具身智能以自我意识的信息模型为核心，统一观察、学习、行动与系统验证。",
    }}
    en={{
      ...
      sources: [["Information is not utility: self-awareness article", "https://mp.weixin.qq.com/s?__biz=MzYzOTIyNDYyNw==&mid=2247484239&idx=1&sn=ed7b32ef7f916a282da9ba673ffe481c"], ["About us · Angsheng Li’s research team", "/team"]],
      closing: "Information-principled embodied intelligence takes the information model of self-awareness as its core and unifies observation, learning, action, and system verification.",
    }}
  />;
}
