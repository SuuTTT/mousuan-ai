...
export default function EmbodiedIntelligencePage() {
  return <PrinciplePage
    zh={{
      ...
      sections: [["身体是信息接口", "智能不只存在于参数中。身体、传感器、动作和环境共同构成信息交换的边界，智能体必须在其中建立对自身与世界的表示。"], ["自我意识与行动", "具身智能体需要知道自己能做什么、当前处于什么状态、行动会带来什么变化；这种自我表示支撑自主、可信与可验证的行动。"], ["面向智能机", "从结构信息到世界模型，研究路线把感知、学习、谋算与控制组织在同一闭环中，连接智能体、智能机和机器人。"]],
      ...
      closing: "这里使用“具身智能”作为正式术语；本页是团队研究方向的解释性入口。",
    }}
    en={{
      ...
      closing: "The formal term used here is embodied intelligence; this page is an explanatory entry point for the team’s direction.",
    }}
  />;
}
