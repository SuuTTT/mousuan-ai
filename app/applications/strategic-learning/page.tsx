...
export default function StrategicLearningPage() {
  return <PrinciplePage
    zh={{
      ...
      title: "谋算学习\n让学习过程可以解释",
      lead: "基于谋算智能（MouSuan Intelligence, MSI）原理，把学习从已有的黑箱拟合推进到结构发现、信息解码与策略生成。",
      ...
      closing: "谋算学习的形式基础由结构信息原理、编码树、结构熵与层级决策方法共同构成。",
    }}
    en={{
      ...
      lead: "MouSuan Intelligence (MSI) moves learning beyond existing black-box fitting toward hierarchical structure discovery, information decoding, and strategy generation.",
      sections: [["What learning models", "Learning is not only a correlation between inputs and outputs. It is an understanding of structure, hierarchy, constraints, and change in an environment."], ["The Mou brain", "Hierarchically abstracting and global recognition and reasoning let a model show what it observed and how it organised knowledge across levels of abstracting."], ["The Suan brain", "Divide-and-conquer calculation turns recognised structure into local computations, strategy generation, and decisions that can be verified."], ["From learning to strategic design", "Once learned structure can be decoded and verified, a system can generate strategy, decide autonomously, and verify its actions—a closed loop from observation to strategic design and action."]],
      ...
      closing: "The formal basis of MouSuan learning combines structural-information principles, encoding trees, structural entropy, and hierarchical decision-making.",
    }}
  />;
}
