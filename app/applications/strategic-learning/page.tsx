...
export default function StrategicLearningPage() {
  return <PrinciplePage
    ...
    en={{
      ...
      sections: [["What learning models", "Learning is not only a correlation between inputs and outputs. It is an understanding of structure, hierarchy, constraints, and change in an environment."], ["The Mou brain", "Hierarchically abstracting and global recognition and reasoning let a model show what it observed and how it organised knowledge across levels of abstracting."], ["The Suan brain", "Divide-and-conquer calculation turns recognised structure into local computations, strategy generation, and decisions that can be verified."], ["From learning to planning", "Once learned structure can be decoded and verified, a system can generate strategy, decide autonomously, and verify its actions—a closed loop from observation to planning."]],
