...
export default function StructuredDecisionMakingPage() {
  return <PrinciplePage
    zh={{
      ...
      closing: "层级决策的形式模型、算法、证明与实验结果见 JMLR 原始论文。",
    }}
    en={{
      ...
      closing: "The formal model, algorithms, proofs, and experiments for hierarchical decision-making appear in the original JMLR paper.",
    }}
  />;
}
