...
export default function StructuredDecisionMakingPage() {
  return <PrinciplePage
    zh={{
      ...
      sources: [["Hierarchical Decision Making Based on Structural Information Principles · JMLR", "https://jmlr.org/papers/volume26/24-1184/24-1184.pdf"], ["Xianghua Zeng · DBLP", "https://dblp.org/pid/165/5653.html"], ["结构信息原理页", "/principles/structural-information"]],
