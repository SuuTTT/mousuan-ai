...
export default async function ResearchModulePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main className={`module-page module-${module.no}`}>
    ...
    <section className="module-return"><div className="module-shell"><p>科学问题与研究模块是两种互补入口</p><div><a href="/#questions"><span>FIVE QUESTIONS</span><strong>返回五个问题</strong><b>→</b></a><a href="/framework"><span>PRINCIPLE INDEX</span><strong>查看关键原理索引</strong><b>→</b></a></div></div></section>
