...
const content = {
  zh: {
    ...
    hero: "谋算智能\n— 揭示智能实质的科学原理。",
    intro: "谋算智能科学技术（MouSuan Intelligence）：谋算双脑体系结构是谋算智能的核心，是信息科学与计算科学结合的产物；它让人工智能有原理、可解释、高效、可信、自主、可控，并形成中国原始创新的完整技术路线。",
    explore: "探索四大板块",
    watch: "关于我们",
  ...
  en: {
    ...
    teamIntro: "MouSuan Intelligence (MSI) is built around a dual-brain architecture that combines information science with computer science. Our team carries this Chinese original innovation into self-awareness machines, the Sun Tzu model, MouSuan dual-brain architecture intelligent machines, and MouSuan intelligent robots.",
    ...
    directions: [
      ...
      ["04", "MouSuan Intelligence machines", "MouSuan dual-brain architecture intelligent machines combine global cognition, cross-level reasoning, calculation, and autonomous decisions.", [], "https://jmlr.org/papers/volume26/24-1184/24-1184.pdf"],
