...
const content = {
  ...
  en: {
    ...
    pillars: [
      { no: "01", title: "Scientific principles", summary: "From structural information to mathematical principles of information: how the information world is defined, organised, and decoded.", question: "How can structure carry information and become inferable knowledge?", href: "/framework#model", action: "Explore principles", links: [["Structural information", "/principles/structural-information"], ["Mathematical principles of information", "/principles/information-mathematics"], ["Machine-intelligence principles", "/principles/ai-principles"]] as Link[], cite: "[1]" },
      { no: "02", title: "MouSuan strategy", summary: "Mou organises the whole through hierarchies; Suan computes and reasons locally. Together they bring whole-system goals into executable strategy.", question: "How can whole-system recognition and local problem solving inform each other?", href: "/framework#page-14", action: "Explore MouSuan", links: [["MouSuan Intelligence", "/principles/strategic-intelligence"], ["Sun Tzu model & books", "/books"], ["Hierarchical decision paper", "https://jmlr.org/papers/volume26/24-1184/24-1184.pdf"]] as Link[], cite: "[2]" },
      { no: "03", title: "Machine intelligence & applications", summary: "Put principles and strategy into learning, decision making, embodied systems, and verifiable intelligent machines.", question: "How can a system understand the whole, calculate the local, and act effectively?", href: "/framework#machine", action: "Explore applications", links: [["Structured AI", "/applications/structured-ai"], ["Strategic learning", "/applications/strategic-learning"], ["Structured decision making", "/applications/structured-decision-making"], ["Embodied intelligence", "/applications/embodied-intelligence"]] as Link[], cite: "[2]" },
      { no: "04", title: "Knowledge & research", summary: "Find terms, papers, code, and research records here. Each key proposition returns to traceable primary sources.", question: "Which sources let each claim be checked further?", href: "/framework#information", action: "Explore research", links: [["Terminology Wiki", "/wiki/terminology"], ["Structural entropy survey", "https://www.ijcai.org/proceedings/2025/1183"], ["Research repository", "https://github.com/SuuTTT/structural-entropy-survey"], ["Audit record", "/audit-redesign/"]] as Link[], cite: "[1][2][3]" },
    ],
