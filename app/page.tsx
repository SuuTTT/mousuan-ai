...
const levels = [
  {
    ...
    nodes: [
      [["物理世界", "Physical world"], ["对象自身决定其物理性质；以分而治之分析，以经典数学和微积分为支撑。", "An object determines its physical properties; divide-and-conquer, classical mathematics, and calculus provide the analytical basis."], ["物理性质", "PHYSICAL PROPERTY"], "/framework#definitions"],
      [["信息世界", "Information world"], ["存在性、作用、运动性，以及主体的需求和愿望，构成对象的信息性质。", "Existence, role, movement, and a subject's needs and desires form informational properties."], ["信息性质", "INFORMATIONAL PROPERTY"], "/framework#definitions"],
      [["信息系统", "Information system"], ["信息性质嵌入对象之间的关系系统，不能只通过拆分单个对象获得。", "Informational properties are embedded in systems of relations and cannot be recovered by decomposing one object alone."], ["系统关系", "SYSTEM RELATIONS"], "/framework#laws"],
      [["完备知识", "Complete knowledge"], ["物理性质与信息性质联合，形成现实世界对象的完备知识。", "Physical and informational properties together form complete knowledge of an object."], ["物质 + 信息", "MATTER + INFORMATION"], "/framework#definitions"],
    ] as const,
    modules: [] as const,
  },
  {
  ...
  },
  {
    ...
    modules: [
      ...
      [["孙子模型", "Sun Tzu model"], ["把谋算策略转化为可研究、可设计、可验证的智能模型。", "Turn MouSuan strategy into an intelligent model that can be studied, designed, and verified."], "/books"],
    ] as const,
  },
] as const;
...
const ui = {
  zh: {
    nav: [["公理原理", "/principles/structural-information"], ["应用成果", "/applications/structured-ai"], ["孙子模型", "/books"], ["知识与研究", "/wiki/terminology"]],
  ...
  en: {
    nav: [["Principles", "/principles/structural-information"], ["Applications", "/applications/structured-ai"], ["Sun Tzu model", "/books"], ["Knowledge", "/wiki/terminology"]],
