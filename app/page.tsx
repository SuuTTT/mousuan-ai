...
const content = {
  zh: {
    ...
    teamIntro: "我们研究智能的数学原理，并将其落实为自我意识机器、孙子模型、谋算智能机器与谋算智能机器人。谋算双脑体系结构是谋算智能的核心，连接信息科学与计算科学，形成中国原始创新的人工智能科学技术路线。",
