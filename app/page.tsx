...
const ui = {
  zh: {
    nav: [["五个问题", "#questions"], ["信息中心", "#center"], ["三个定义", "#definitions"], ["孙子模型", "#model"], ["五大模块", "#modules"], ["建设历程", "/activities"], ["团队", "/team"]],
    ...
    activitiesLabel: "SYSTEM CHRONICLE",
    activitiesTitle: "机器智能科学技术体系建设历程",
    activitiesText: "记录谋算智能相关活动、获奖、人才项目与文章，呈现机器智能科学技术体系的创建过程。",
    activitiesItem: "2026 年会 · 谋算智能论坛",
    activitiesMeta: "2026 年 8 月 22 日 · 5 场论坛报告",
    activitiesEnter: "查看建设历程",
    footer: "机器智能原理：信息模型，机器原理，智能工程",
  },
  en: {
    nav: [["Five questions", "#questions"], ["Information", "#center"], ["Three definitions", "#definitions"], ["Sun Tzu Model", "#model"], ["Five modules", "#modules"], ["Chronicle", "/activities"], ["Team", "/team"]],
    ...
    activitiesLabel: "SYSTEM CHRONICLE",
    activitiesTitle: "Building the System",
    activitiesText: "Activities, awards, talent programmes, and articles record the development of the system of machine intelligence science and technology.",
    activitiesItem: "2026 Annual Meeting · MouSuan Intelligence Forum",
    activitiesMeta: "22 August 2026 · Five forum talks",
    activitiesEnter: "View the chronicle",
