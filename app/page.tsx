...
const content = {
  zh: {
    ...
    hero: "谋算智能\n— 揭示智能实质的科学原理",
    intro: "谋算智能科学技术（Science and Technology of MouSuan Strategy）：人的智能策略就是“谋”和“算”，谋算双脑体系结构是谋算智能的核心，是信息科学与计算科学结合的产物；它让人工智能有原理、可解释、高效、可信、自主、可控，并形成中国原始创新的完整技术路线。",
    explore: "探索四大板块",
    watch: "关于我们",
    signal: "STRUCTURE / LEARNING / STRATEGY / INTELLIGENCE",
    manifesto: "智能不是一个黑箱。它可以被观察、解码、生成、组织、编码，并被赋予可检验的原理。一个自我意识体的智能就是它的信息：智能 = 信息。信息是解码信息世界的钥匙。信息是创建智能科学原理的数学基础。“智”是策略性设计，“能”是高效行动；智能是二者的统一，智能需要行动。",
    ...
    breakthroughs: [
      ...
      ["2024", "信息的数学原理", "信息世界的公理化数学原理，也即离散系统的微积分；包含信息演算、信息解码与信息生成原理。", "/principles/information-mathematics"],
    ...
    applications: [
      ...
      ["02", "具身智能", "以自我意识的信息理论为核心，探索自主、可信、可验证的智能体与智能机。", "/applications/embodied-intelligence"],
    ...
    suntzuLead: "《孙子兵法》以战争现象为对象，把物质与信息结合为动态演化的体系对抗博弈；孙子模型把它转化为可研究、可设计、可验证的人工智能框架。孙子模型是谋算智能的模型——一个面向策略设计和有效行动的有原理模型。",
    ...
    teamIntro: "我们研究智能的数学原理，并将其落实为自我意识机器、孙子模型、谋算智能机与谋算智能机器人。谋算双脑体系结构是谋算智能的核心，连接信息科学与计算科学，形成中国原始创新的人工智能科学技术路线。",
    ...
    directions: [
      ...
      ["04", "谋算智能机", "把信息解码、策略生成与自主决策结合为有原理的谋算双脑体系结构智能机。", [], "https://jmlr.org/papers/volume26/24-1184/24-1184.pdf"],
    ...
    people: [
      ...
      ["卫一帆", "大语言模型、知识编辑、智能体与 AI safety", [["个人主页", "https://weiyifan1023.github.io/"], ["GitHub", "https://github.com/weiyifan1023"], ["DBLP", "https://dblp.org/pid/204/1769-1.html"]], "/people/yifan-wei.jpg"],
      ["苏丁力", "结构信息决策、结构熵与智能系统工程", [["个人主页", "https://suuttt.github.io/"], ["DBLP", "https://dblp.org/pid/362/8210.html"], ["代表论文", "https://jmlr.org/papers/volume26/24-1184/24-1184.pdf"]], "/people/dingli-su.jpg"],
    ],
  ...
  en: {
    ...
    ids: ["discover", "principles", "applications", "suntzu", "about", "library"],
    kicker: "Structural information · AI · MouSuan Strategy (MSI)",
    hero: "MouSuan Strategy:\nMathematical Principles for Revealing the Essence of Intelligence",
    intro: "MouSuan Strategy (MSI): its dual-brain architecture is the core, combining information science with computer science into a new AI science and technology route rooted in Chinese original innovation.",
    ...
    foundationLead: "Using hierarchically abstracting as the general method, we establish information calculus, decoding, and generation: axiomatized mathematical principles of the information world, namely the calculus of discrete systems, together with principles of learning, self-awareness, and strategic games.",
    breakthroughs: [
      ...
      ["2024", "Mathematical principles of information", "Axiomatized mathematical principles of the information world—equivalently, the calculus of discrete systems—covering information calculus, decoding, and generation.", "/principles/information-mathematics"],
      ["2024", "Information science of MouSuan Strategy (MSI)", "Observation-based learning, self-awareness, and strategic games form the three pillars of a principled intelligence science.", "/principles/strategic-intelligence"],
    ...
    suntzuTitle: "Mou and Suan: intelligence through recognition and computation",
    ...
    laws: ["War is a system-level contest combining matter and information", "Outcomes are determined by the combination of matter and information", "War phenomena have measurable, inferable regularities", "Mou and Suan decode information and generate strategy", "Knowing the adversary, self, time, and terrain creates the conditions for victory"],
    ...
    peopleLead: "Professor Angsheng Li’s team builds on structural information and AI science to turn existing AI black boxes into an explainable, verifiable white-box route—from computation to MouSuan Strategy (MSI).",
    teamIntro: "MouSuan Strategy (MSI) is built around a dual-brain architecture that combines information science with computer science. Our team carries this Chinese original innovation into self-awareness machines, the Sun Tzu model, MouSuan dual-brain architecture intelligent machines, and MouSuan intelligent robots.",
    ...
    directions: [
      ...
      ["04", "MouSuan Strategy machines", "MouSuan dual-brain architecture intelligent machines combine global recognition and reasoning, calculating and reasoning that cross the hierarchies of abstracting, computation, and autonomous decisions.", [], "https://jmlr.org/papers/volume26/24-1184/24-1184.pdf"],
    ...
    plans: [
      ["01", "Sun Tzu Model (MouSuan system)", "A MouSuan intelligence system based on the scientific principles of the information world", "The Sun Tzu Model is a model of MouSuan Intelligence—a principled, explainable model for strategic design and effective action, with civilian and military versions.", "/books"],
      ["02", "Sun Tzu Machine (MouSuan machine)", "A MouSuan dual-brain intelligent machine based on the scientific principles of the information world", "A principled, explainable intelligent machine.", "/principles/strategic-intelligence"],
    ],
    people: [
      ["Angsheng Li", "Structural information, information-world mathematics, and intelligence science", [["Key paper", "https://arxiv.org/abs/2001.09637"], ["DBLP", "https://dblp.org/pid/66/4917.html"]], "/people/angsheng-li.jpg"],
      ...
      ["Yifan Wei", "Large language models, knowledge editing, agents, and AI safety", [["Homepage", "https://weiyifan1023.github.io/"], ["GitHub", "https://github.com/weiyifan1023"], ["DBLP", "https://dblp.org/pid/204/1769-1.html"]], "/people/yifan-wei.jpg"],
      ["Dingli Su", "Structural-information decision-making, structural entropy, and intelligent systems", [["Homepage", "https://suuttt.github.io/"], ["DBLP", "https://dblp.org/pid/362/8210.html"], ["Key paper", "https://jmlr.org/papers/volume26/24-1184/24-1184.pdf"]], "/people/dingli-su.jpg"],
    ],
