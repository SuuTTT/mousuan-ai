...
const themes = [
  {
    ...
    statement: ["建立信息的公理化数学原理，为人工智能科学建立数学基础。", "Establish axiomatized mathematical principles of information as the mathematical foundation of artificial intelligence science."] as Bi,
...
const ui = {
  zh: {
    ...
    kicker: "信息世界数学原理",
    title: "人工智能的\n四个科学问题",
    lead: "建立信息世界的公理化数学原理，并从数学实质、机器原理和实现模型三个维度回答智能的科学问题。孙子模型统一人工智能的科学原理与工程原理：智是科学原理，能是工程原理。",
    explore: "查看四个问题",
    reference: "查看关键原理",
    guide: "四个问题 · 四个回答",
    sectionLabel: "ULTIMATE GOALS OF AI SCIENCE",
    sectionTitle: "四个问题及其回答",
    sectionSummary: "信息世界的公理化数学原理构成数学基础；其后三项从数学实质、机器原理和实现模型三个维度回答智能的科学问题。",
    enter: "进入主题",
  ...
  en: {
    ...
    lead: "The theory establishes axiomatized mathematical principles of the information world, then answers intelligence through its mathematical essence, machine principle, and realization model. The Sun Tzu Model unifies the scientific and engineering principles of AI: Zhi is science; Neng is engineering.",
    ...
    sectionSummary: "Axiomatized mathematical principles of the information world provide the mathematical foundation; the following three answers address intelligence through its mathematical essence, machine principle, and realization model.",
    enter: "Open theme",
    modulesLabel: "RESEARCH PROGRAMMES",
