...
const content = {
  zh: {
    ...
    plansKicker: "两项重大计划 · 原始创新研究",
    plansTitle: "重大、原始创新、标志性、颠覆性的研究计划",
    plansLead: "围绕信息世界科学原理，集中推进两个可形成标志性系统的长期研究计划。",
    plans: [
      ["01", "孙子模型（谋算系统）", "基于信息世界科学原理的谋算智能系统", "有原理、可解释的世界模型；形成民用版与军用版。", "/books"],
      ["02", "孙子机（谋算机）", "基于信息世界科学原理的谋算双脑智能机器", "有原理、可解释的智能机器。", "/principles/strategic-intelligence"],
    ],
    people: [
  ...
  en: {
    ...
    plans: [
      ["01", "Sun Tzu Model (MouSuan system)", "A MouSuan intelligence system based on the scientific principles of the information world", "A principled, explainable world model with civilian and military versions.", "/books"],
