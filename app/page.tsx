...
const content = {
  ...
  en: {
    ...
    intro: "MouSuan Intelligence (MSI): AI generated by two complementary strategies—hierarchical abstraction for global cognition (encoding), and calculating for reasoning and action (computing).",
    ...
    teamIntro: "MouSuan Intelligence (MSI) is intelligence generated by two complementary strategies: hierarchical abstraction for global cognition (encoding), and calculating for reasoning and action (computing). Our team carries this into self-awareness machines, the Sun Tzu model, MouSuan dual-brain architecture intelligent machines, and MouSuan intelligent robots.",
