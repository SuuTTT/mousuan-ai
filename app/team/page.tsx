...
const members: readonly TeamMember[] = [
  {
    name: "李昂生",
    bio: "提出现实世界科学的两个世界理论，即物理世界和信息世界；提出包括信息世界认知模型定律在内的信息世界十大定律；创建包括信息演算理论、信息解码原理和信息生成原理的信息的数学原理；创建包括学习的信息理论、自我意识的信息理论和谋算博弈理论的智能的信息科学原理；提出智能实质的智能论题“智能 = 信息”、智能生成的谋算策略原理“智能 = 谋算”、智能的表示定律“智能 = 智 + 能”以及智能实现的孙子模型；提出物质与信息结合的孙子五大定律。",
  ...
  { name: "许可", bio: "研究算法与复杂性、数据挖掘、网络与信息传播。", image: "/people/ke-xu.jpg", links: [["北航主页", "https://scse.buaa.edu.cn/info/1078/2655.htm"]] },
  { name: "曾祥华", bio: "研究层级决策、多智能体协同与结构信息原理。", image: "/people/xianghua-zeng.jpg", links: [["DBLP", "https://dblp.org/pid/165/5653.html"], ["代表论文", "https://jmlr.org/papers/volume26/24-1184/24-1184.pdf"]] },
  { name: "卫一帆", bio: "研究大语言模型、知识编辑、智能体与机器智能安全。", image: "/people/yifan-wei-20260802.jpg", links: [["个人主页", "https://weiyifan1023.github.io/"], ["GitHub", "https://github.com/weiyifan1023"], ["DBLP", "https://dblp.org/pid/204/1769-1.html"]] },
  { name: "苏丁力", bio: "研究结构信息决策、结构熵与智能系统工程。", image: "/people/dingli-su-20260802.jpg", links: [["个人主页", "https://suuttt.github.io/"], ["DBLP", "https://dblp.org/pid/362/8210.html"], ["代表论文", "https://jmlr.org/papers/volume26/24-1184/24-1184.pdf"]] },
] as const;
...
export default function TeamPage() {
  return <main className="team-page">
    <nav className="team-nav"><a className="team-brand" href="/"><img src="/logo-encoding-tree.svg" alt="" /><b>MACHINE<br />INTELLIGENCE</b></a><div><a href="/">研究主页</a><a href="/#questions">五个问题</a><a href="/#definitions">三个定义</a><a href="/#modules">五大模块</a><a href="/books">三部专著</a></div></nav>
    <header className="team-hero"><div><p>ABOUT US · 李昂生团队</p><h1>把信息科学原理<br />变成智能机</h1><span>团队以结构信息、信息的数学原理、机器智能技术和智能科学为基础，从计算到谋算，把已有黑箱变成有原理、可解释、可验证的机器智能。</span></div><aside><strong>研究路线</strong><p>谋算双脑体系结构连接信息科学与计算科学，并落实为观察学习机、自我意识机、孙子模型、谋算智能机与谋算智能机器人。</p></aside></header>

    <section className="team-members team-shell"><header><p>CORE TEAM</p><h2>核心成员</h2><span>团队成员共同推进结构信息、机器智能科学与谋算智能研究。</span></header><PeopleGroup /></section>
