...
export default function TeamPage() {
  return <main className="team-page">
    <nav className="team-nav"><a className="team-brand" href="/"><img src="/logo-encoding-tree.svg" alt="" /><b>STRUCTURAL<br />INTELLIGENCE</b></a><div><a href="/">研究主页</a><a href="/#questions">五个问题</a><a href="/#definitions">三个定义</a><a href="/#modules">五大模块</a><a href="/books">三部专著</a></div></nav>
