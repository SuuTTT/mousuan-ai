...
export default function TeamPage() {
  return <main className="team-page">
    ...
    <section className="team-members team-shell"><header><p>CORE TEAM</p><h2>核心成员</h2><span>按照教授、博士生的顺序介绍研究团队。</span></header><PeopleGroup title="教授 · FACULTY" people={faculty} /><PeopleGroup title="博士生 · PHD STUDENTS" people={students} /></section>
