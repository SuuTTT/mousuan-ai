...
const copy = {
  zh: {
    ...
    books: [
      ...
      { year: "2026", kind: "PDF", title: "孙子兵法的\n人工智能原理", enTitle: "AI Principles of Sun Tzu’s The Art of War", meta: "李昂生、潘祎诚、李永瑾、曾祥华、许可、许京奕等著 · 1,115 pages", summary: "以战争现象为对象，提出物质与信息结合的公理化科学原理、孙子五大定律、信息军事科学与孙子模型。孙子模型是谋算智能的模型——一个面向策略设计和有效行动的有原理模型。", parts: ["物质与信息结合", "孙子五大定律", "信息军事科学", "孙子模型 / 孙子机"], links: [["打开团队提供的原始 PDF", "/sun-tzu-ai-principles.pdf"]] as BookLink[] },
    ],
  ...
  en: {
    ...
    books: [
      ...
      { year: "2024", kind: "BUY", title: "Principles of Artificial Intelligence\nModels, Principles, and Methods from Computation to MouSuan", enTitle: "人工智能原理 — 从计算到谋算的模型、原理与方法", meta: "By Angsheng Li · Published book", summary: "From computational principles, neural networks, and machine learning to strategic games and information-science principles of AI: an AI combining Mou recognition with Suan computing and logical reasoning.", parts: ["Computational principles", "Neural networks", "Machine learning", "Games / MouSuan"], links: [["Sanmin Bookstore", "https://www.sanmin.com.tw/product/index/013828865"]] as BookLink[] },
      { year: "2026", kind: "PDF", title: "AI Principles of\nSun Tzu’s The Art of War", enTitle: "孙子兵法的人工智能原理", meta: "By Angsheng Li, Yicheng Pan, Yongjin Li, Xianghua Zeng, Ke Xu, Jingyi Xu et al. · 1,115 pages", summary: "A system of Axiomatized Science Principles combining matter and information, including the five Sun Tzu laws and information military science. The Sun Tzu Model is a model of MouSuan Intelligence—a principled model for strategic design and effective action.", parts: ["Matter and information", "Five Sun Tzu laws", "Information military science", "Sun Tzu model / machine"], links: [["Open team-provided original PDF", "/sun-tzu-ai-principles.pdf"]] as BookLink[] },
    ],
